...
mapa = {
    ...
    "ADU451807V01.pafx": {"Port 1 - +45": (3, 0), "Port 2 - -45": (3, 0)},
    "ATR4518R25v06.pafx": {
    ...
    "7422901.pafx": {"Port 1": (2, 3)},
    "742215.pafx": {"Port 1 - +45": (3, 0), "Port 2 - -45": (3, 0)},
    "CELLMAX-D-CPUSE.pafx": {"VERTICAL": (2, 3)},
    "80010681.pafx": {"Port 1 - +45": (3, 4), "Port 2 - -45": (3, 4)},
}
...
def recibir(name):
    ...
    for row in range(2, maxRow + 1):
        for col in range(1, maxColumn + 2):
            ...
            if (
                col < 7
            ):  # Hast la columna F se debe de repetir 3 veces en la hoja de salida
    ...
    for row in range(2, maxRow + 1):
        ...
        vectorPropagacion = []
        condiciones = [
            wsImport["M" + str(row)].value,
            wsImport["N" + str(row)].value,
            wsImport["O" + str(row)].value,
        ]
        maxRowExp = 0
        # print(condiciones)
        if condiciones[0] == "Y":
            ...
            auxiliarSectores = [
                "NewUM_masked_2100MHz_tuned.pmf",
                "NewUM_masked_2100MHz_tuned.pmf",
                "NewUM_masked_2100MHz_tuned.pmf",
            ]
    ...
    fechaLimite = datetime.date(2022, 6, 30)
